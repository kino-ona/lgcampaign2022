					...
					<div class="section__inner">
						<div class="section__header">
							...
							<p class="section__desc">
								Save Big with Exclusive Member Benefits on LG products
								Limited Time Sale Ends 20<sup>th</sup> Dec 2022, Only at LG.com
							</p>
						</div>
						<div class="button">
							<a href="#MembershipEvent" class="button__item button__item--red">View Products</a>
						</div>
				...
				<div class="section__container section__container--hottest" data-list="hottest">
					<div class="section__inner">
						<div class="section__header">
							...
							<p class="section__desc">
								Buy More than Two Products and <span class="break break--mobile">get <em class="highlight">15% Discount</em></span>
								...
								<div class="discount__item">
									<div class="discount__inner">
										<ul class="discount__number">
											<li>
												<p class="discount__total">15% Discount</p>
											</li>
											<li>
						...
						<div class="tab">
							...
							<div id="tvcinebeam" class="tab__panel" style="display: block;">
								<p class="tab__noti">
									...
									Remember to apply 15% Discount Coupon and 5% Welcome Coupon at <em>My Basket</em>
								</p>
								<div class="product">
									<div class="product__mask">
