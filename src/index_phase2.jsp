								...
								<div class="product__item">
									...
									<div class="product__info products-info">
										...
										<div class="learn-more">
											<a role="button" href="*modelUrlPath*" class="learn-more__link" target="_blank" data-track-group="product" data-track-group="product" data-model-id="*modelId*" data-bu="*buName1*" data-model-year="*modelYear*" data-model-name="*modelName*" data-super-category-name="*superCategoryName*" data-category-name="*buName2*" data-sub-category-name="*buName3*" data-model-code="*salesModelCode*" data-price="*priceValue*" data-link-area="buy_now_click" data-track-name="buy_now_click" data-link-name="buy_now">
								...
								<template class="contents-template">
									<div class="product__item">
										...
										<div class="product__info products-info">
											...
											<div class="learn-more">
												<a role="button" href="*modelUrlPath*" class="learn-more__link" target="_blank" data-track-group="product" data-track-group="product" data-model-id="*modelId*" data-bu="*buName1*" data-model-year="*modelYear*" data-model-name="*modelName*" data-model-code="*salesModelCode*" data-price="*priceValue*" data-link-area="sparkling_buy_now_click" data-track-name="sparklingdeals_buy_now_click" data-link-name="sparklingdeals_buy_now">
													<span class="learn-more__text"><spring:message code='component-learnMore' text='LEARN MORE'/></span>
												</a>
											</div>
										</div>
								...
								<div class="discount__item">
									<div class="discount__inner">
										<ul class="discount__number">
											<li>
												<p class="discount__total">10% Discount</p>
											</li>
											<li>
											...
											<li>
												<p>
													5% Welcome Discount
													<span>(only applies to newly joined members)</span>
												</p>
											</li>
										</ul>
									</div>
							...
							<template class="contents-template">
								<li class="product__item">
									...
									<div class="product__info products-info">
										...
										<div class="learn-more">
											<a role="button" href="*modelUrlPath*" class="learn-more__link" target="_blank" data-track-group="product" data-track-group="product" data-model-id="*modelId*" data-bu="*buName1*" data-model-year="*modelYear*" data-model-name="*modelName*" data-super-category-name="*superCategoryName*" data-category-name="*buName2*" data-sub-category-name="*buName3*" data-model-code="*salesModelCode*" data-price="*priceValue*" data-link-area="offer_buy_now_click" data-track-name="offer_buy_now_click" data-link-name="offer_buy_now">
												<span class="learn-more__text"><spring:message code='component-learnMore' text='LEARN MORE'/></span>
												<i class="learn-more__arrow"></i>
											</a>
										</div>
