								...
								<div class="product__item">
									...
									<div class="product__info products-info">
										...
										<div class="learn-more">
											...
											data-super-category-name="*superCategoryName*" data-category-name="*buName2*" data-sub-category-name="*buName3*" data-track-name="buy_now_click" data-link-name="buy_now" target="_blank">
				...
				<div class="section__container section__container--hottest" data-list="hottest">
					<div class="section__inner">
						<div class="section__header">
							...
							<p class="section__desc">
								GIẢM LÊN ĐẾN 17% KHI MUA TỪ 02 SẢN PHẨM <em class="highlight">BẤT KÌ</em>
								<span>(Không bao gồm các sản phẩm thuộc danh sách “Ưu đãi Đặc biệt”)</span>
							</p>
						</div>
            <div class="discount">
